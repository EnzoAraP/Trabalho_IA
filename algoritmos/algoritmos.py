        ...
        while((fracasso or sucesso)):
            if(atual.regra.get("d")==0 or atual.regra.get("b")==0 or atual.regra.get("e")==0  or atual.regra.get("c")==0 ):
                ...
                if atual.valor == estadoInicial:
                    ...
                    atual = atual.pai             
        return 0
    def movimentacao(self,Noatual,direcao,listaVisto,modo):#se estiver correto, só será mudado para o novo nó se ele não estiver adicionado na lista, se não retorna o atual.
